...
class LoginFrame(tk.Frame):
    ...
    LOGIN_AREA_EXTERNAL_HORIZONTAL_PADDING = 150
    ...
    CIVIL_USER_LABEL_TEXT = "Visualize empresas e obras sem senha."
    ...
    def setUpAllUserTypeButtons(self):
        ...
        self.setUpUserTypeButton(buttons_frame, "empresa", position=1)
    ...
    def nonCivilUserLogin(self, user_type: str):
        self.showField("E-mail")
        v_padding_email = self.LOGIN_FIELD_EMAIL_PACK_VERTICAL_PADDING
        email_entry = self.captureFieldInput(v_padding_email)
    ...
    def captureFieldInput(self, vertical_padding, show: str = "") -> tk.Entry:
        input_widget = tk.Entry(self.login_area_frame, show=show)
        input_widget.pack(fill=self.LOGIN_FIELD_INPUT_PACK_FILL,
